...
class HomeController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        // Configures the Home label on the top navigation bar
    ...
    func setupCollectionView() {
        ...
        // Sets up the cells within the collection view
        collectionView.register(FeedCell.self, forCellWithReuseIdentifier: cellId)
        collectionView.register(TrendingCell.self, forCellWithReuseIdentifier: trendingCellId)
        collectionView.register(SubscriptionCell.self, forCellWithReuseIdentifier: subscriptionCellId)
        
        // Sets the content within the collection view to be 50 pixels from the top
        // Prevents overlap of the menu bar and the thumbnail image
    ...
    // Sets up and styles the navigation bar
    ...
    // Shows the settings menu when the 'more' icon is pressed
    @objc func handleMore() {
        settingsLauncher.showSettings()
    }
    
    // Navigates to the controller associated with the chosen setting
    ...
    // Sets up and styles the menu bar
    private func setupMenuBar() {
        ...
        // Sets the constraints for the menu bar so that it replaces the navigation bar's
        // location when the view is swiped up/down
