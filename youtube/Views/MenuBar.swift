...
class MenuBar: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    // Names of the asset image names to be referenced in the menu cell setup
    ...
    override init(frame: CGRect) {
        ...
        // Initializes the first cell (home icon) to be highlighted upon startup
    ...
    // Sets up the contents of each cell with corresponding icons
    ...
    // Sets the width and height of each cell within the collection view
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize(width: frame.width / 4, height: frame.height)
    }
    
    // Sets the minimum spacing between each cell to be zero
